      ...
      <div className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 sm:py-12">
          ...
          <div className="mt-8 flex justify-center">
            <div className="relative rounded-3xl max-w-md animate-glow-pulse animate-float">
              ...
              <div className="absolute top-4 left-4 right-4 z-10">
                <p className="text-lg sm:text-xl text-foreground text-center bg-background/35 backdrop-blur-md py-2 px-4 rounded-xl shadow-lg">
