...
import sonicSimLogo from "@/assets/SonicSIM_clean.png";
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 sm:py-12">
          <div className="text-center">
            <img
              src={sonicSimLogo}
              alt="SonicSIM"
              className="mx-auto h-[127px] sm:h-[169px] md:h-[211px] w-auto object-contain select-none brightness-[1.2] mix-blend-screen"
              draggable={false}
            />
          </div>
