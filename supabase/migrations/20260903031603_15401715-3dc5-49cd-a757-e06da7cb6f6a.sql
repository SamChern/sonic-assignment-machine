...
REVOKE ALL ON FUNCTION public.intuizi_activation_cost_estimate(integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.intuizi_activation_cost_estimate(integer) TO authenticated, service_role;