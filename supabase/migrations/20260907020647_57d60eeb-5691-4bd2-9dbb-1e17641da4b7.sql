CREATE OR REPLACE FUNCTION public.public_audio_sources(_user_ids uuid[] DEFAULT NULL, _limit integer DEFAULT 200)
RETURNS TABLE(
...
AS $$
  ...
  WHERE _user_ids IS NULL OR s.user_id = ANY(_user_ids)
